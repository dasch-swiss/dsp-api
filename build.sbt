...
addCommandAlias(
  "headerCreateAll",
  "; all webapi/headerCreate webapi/Test/headerCreate testkit/headerCreate it/headerCreate it/Test/headerCreate e2e/headerCreate e2e/Test/headerCreate",
)
addCommandAlias(
  "headerCheckAll",
  "; all webapi/headerCheck webapi/Test/headerCheck testkit/headerCheck it/headerCheck it/Test/headerCheck e2e/headerCheck e2e/Test/headerCheck",
)
addCommandAlias("check", "; all root/scalafmtSbtCheck root/scalafmtCheckAll; root/scalafixAll --check; headerCheckAll")
addCommandAlias("it", "it/test")
addCommandAlias("e2e", "e2e/test")
...
lazy val it: Project = Project(id = "it", base = file("modules/it"))
...
lazy val e2e: Project = Project(id = "e2e", base = file("modules/e2e"))
  .dependsOn(webapi, sipi, testkit)
  .settings(buildSettings)
  .settings(
    inConfig(Test) {
