...
#######################################################################################
# Deletes all preview file values from the triplestore, and updates the knora-base
...
def do_request(graphdb_url, username, password):
    with open("sparql/delete-preview-values.rq", 'r') as request_file:
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Deletes preview file values and updates knora-base.")
