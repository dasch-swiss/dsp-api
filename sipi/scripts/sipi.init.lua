...
-- the DSP-API.
-------------------------------------------------------------------------------
local function get_permission_on_file(shortcode, file_name, jwt_token)
...
function pre_flight(prefix, identifier, cookie)
    ...
    local jwt_token = auth_get_jwt()
    local permission_info = get_permission_on_file(prefix, identifier, jwt_token)
...
function file_pre_flight(identifier, cookie)
    ...
    local jwt_token = auth_get_jwt()
    local permission_info = get_permission_on_file(shortcode, file_name, jwt_token)
    local permission_code = permission_info.permissionCode
