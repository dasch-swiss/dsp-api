...
if ! grep -q "httpServiceAllowed" "$FUSEKI_BASE/configuration/dsp-repo.ttl"; then
  warn "Existing dsp-repo.ttl has no arq:httpServiceAllowed setting: federated SERVICE calls are ALLOWED."
