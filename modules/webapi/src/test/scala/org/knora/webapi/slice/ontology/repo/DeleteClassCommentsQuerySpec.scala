...
object DeleteClassCommentsQuerySpec extends ZIOSpecDefault {
  ...
  override def spec: Spec[TestEnvironment, Any] = suite("DeleteClassCommentsQuerySpec")(
      ...
      for {
        ...
        actual ==
          s"""PREFIX xsd: <http://www.w3.org/2001/XMLSchema#>
             ...
             |DELETE { GRAPH <http://www.knora.org/ontology/0001/anything> { anything:Thing rdfs:comment ?comments .
    ...
    test("should produce correct query for different ontology") {
      val differentClassIri =
        ResourceClassIri.unsafeFrom("http://www.knora.org/ontology/0803/incunabula#Book".toSmartIri)
      ...
      for {
        ...
        actual ==
          s"""PREFIX xsd: <http://www.w3.org/2001/XMLSchema#>
             ...
             |DELETE { GRAPH <http://www.knora.org/ontology/0803/incunabula> { incunabula:Book rdfs:comment ?comments .
    ...
    test("should produce correct query with different last modification date") {
      val differentLmd = LastModificationDate.from(Instant.parse("2025-03-10T08:15:45Z"))
      ...
      for {
        ...
        actual ==
          s"""PREFIX xsd: <http://www.w3.org/2001/XMLSchema#>
             ...
             |PREFIX anything: <http://www.knora.org/ontology/0001/anything#>
             |DELETE { GRAPH <http://www.knora.org/ontology/0001/anything> { anything:Thing rdfs:comment ?comments .
             |<http://www.knora.org/ontology/0001/anything> knora-base:lastModificationDate "2025-03-10T08:15:45Z"^^xsd:dateTime . } }
             |INSERT { GRAPH <http://www.knora.org/ontology/0001/anything> { <http://www.knora.org/ontology/0001/anything> knora-base:lastModificationDate "$instant"^^xsd:dateTime . } }
             |WHERE { GRAPH <http://www.knora.org/ontology/0001/anything> { <http://www.knora.org/ontology/0001/anything> a owl:Ontology ;
