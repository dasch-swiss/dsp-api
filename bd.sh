buildozer 'remove deps @maven//:ch_qos_logback_logback_core' //webapi:library
buildozer 'remove deps @maven//:ch_qos_logback_logback_classic' //webapi:library
buildozer 'remove deps @maven//:com_typesafe_akka_akka_slf4j_2_12' //webapi:library
