...
- In particular, @ref:[Gravsearch](../../../03-apis/api-v2/query-language.md) queries should be able
...
In Knora, it is possible to define @ref:[mappings](../../../03-apis/api-v2/xml-to-standoff-mapping.md) to
