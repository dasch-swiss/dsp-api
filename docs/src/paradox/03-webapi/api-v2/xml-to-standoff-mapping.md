...
Please see v1 documentation for general information about the XML to standoff mapping: @ref:[XML To Standoff Mapping v1](../api-v1/xml-to-standoff-mapping.md#xml-to-standoff-mapping).
