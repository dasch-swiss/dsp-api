...
- A Project IRI is normally a small published contract owned by Projects, not a globally owned
  identifier.
...
- **Project Migration** and **Operations** read **Projects** through its published interfaces.
