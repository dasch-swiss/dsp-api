...
ifeq ($(KNORA_AKKA_ACTOR_DEPLOYMENT_HTTPTRIPLESTOREROUTER_NROFINSTANCES), unknown)
	$(warning The number of thread for concurrent request to the tripplestore is not set. Using 10.)
	@echo KNORA_AKKA_ACTOR_DEPLOYMENT_HTTPTRIPLESTOREROUTER_NROFINSTANCES=10 >> .env
else
	@echo KNORA_AKKA_ACTOR_DEPLOYMENT_HTTPTRIPLESTOREROUTER_NROFINSTANCES=$(KNORA_AKKA_ACTOR_DEPLOYMENT_HTTPTRIPLESTOREROUTER_NROFINSTANCES) >> .env
endif
