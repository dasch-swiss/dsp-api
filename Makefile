...
stack-down-delete-volumes: clean-local-tmp clean-sipi-projects clean-sipi-tmp ## stops the knora-stack and deletes any created volumes (deletes the database!).
