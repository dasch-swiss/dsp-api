...
import org.knora.webapi.messages.v2.responder.ontologymessages.{Cardinality, PropertyEntityInfoV2}
...
object StandoffTagUtilV1 {
    ...
    /**
      ...
      */
    private def createAttributes(xmlToStandoffMapping: XMLTagToStandoffClass, classSpecificProps: Map[IRI, Cardinality.Value], existingXMLIDs: Seq[String], standoffNodeFromXML: StandoffTag, standoffPropertyEntities: Map[IRI, PropertyEntityInfoV2]): Seq[StandoffTagAttributeV1] = {
    ...
    private def convertXMLStandoffTagToStandoffTagV1(textWithStandoff: TextWithStandoff,
        ...
        textWithStandoff.standoff.map {
            case (standoffNodeFromXML: StandoffTag) =>
                ...
                val cardinalities: Map[IRI, Cardinality.Value] = standoffEntities.standoffClassInfoMap.getOrElse(standoffClassIri, throw NotFoundException(s"information about standoff class $standoffClassIri was not found in ontology")).allCardinalities
