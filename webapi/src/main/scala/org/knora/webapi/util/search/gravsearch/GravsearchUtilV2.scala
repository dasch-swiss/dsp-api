...
import org.knora.webapi.util.search.gravsearch.GravsearchUtilV2.SparqlTransformation.{ResourceIrisAndValueObjectIris, createUniqueVariableNameFromEntityAndProperty, traverseValuePropertyAssertions}
