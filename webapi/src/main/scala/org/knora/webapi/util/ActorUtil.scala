...
object ActorUtil {
  ...
  /**
    ...
    */
  def future2Message[ReplyT](sender: ActorRef, future: Future[ReplyT], log: LoggingAdapter)(
  ...
  /**
    ...
    * @param log    a [[LoggingAdapter]] for logging non-serializable exceptions.
    */
  def try2Message[ReplyT](sender: ActorRef, tryObj: Try[ReplyT], log: LoggingAdapter)(
      implicit executionContext: ExecutionContext): Unit = {
    tryObj match {
  ...
  /**
    ...
    */
  def handleUnexpectedMessage(sender: ActorRef, message: Any, log: LoggingAdapter, who: String)(
      implicit executionContext: ExecutionContext): Unit = {
  ...
  /**
    ...
    */
  def sequenceFuturesInMap[KeyT: ClassTag, ValueT](mapToSequence: Map[KeyT, Future[ValueT]])(
      implicit timeout: Timeout,
      executionContext: ExecutionContext): Future[Map[KeyT, ValueT]] = {
    Future
      .sequence {
        mapToSequence.map {
  ...
  /**
    ...
    * @return a future that will provide the results of the futures that were in the [[Map]].
    */
  def sequenceFutureSeqsInMap[KeyT: ClassTag, ElemT](mapToSequence: Map[KeyT, Future[Seq[ElemT]]])(
      implicit timeout: Timeout,
      executionContext: ExecutionContext): Future[Map[KeyT, Seq[ElemT]]] = {
  ...
  /**
    ...
    * @return a future that will provide the results of the futures that were in the [[Map]].
    */
  def sequenceSeqFuturesInMap[KeyT: ClassTag, ElemT](mapToSequence: Map[KeyT, Seq[Future[ElemT]]])(
      implicit timeout: Timeout,
      executionContext: ExecutionContext): Future[Map[KeyT, Seq[ElemT]]] = {
  ...
  /**
    ...
    */
  def optionFuture2FutureOption[A](optionFuture: Option[Future[A]])(
  ...
  /**
    ...
    */
  def runTasks[T](firstTask: Task[T])(implicit timeout: Timeout,
...
trait Task[T] {
  ...
  /**
    ...
    */
  def runTask(previousResult: Option[TaskResult[T]])(implicit timeout: Timeout,
                                                     executionContext: ExecutionContext): Future[TaskResult[T]]
}
