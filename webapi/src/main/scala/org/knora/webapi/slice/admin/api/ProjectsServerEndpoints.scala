...
final case class ProjectsServerEndpoints(
  ...
  val serverEndpoints: List[ZServerEndpoint[Any, ZioStreams]] = List(
    projectsEndpoints.Public.getAdminProjects
      .zServerLogic(restService.listAllProjects),
    projectsEndpoints.Public.getAdminProjectsKeywords
      .zServerLogic(_ => restService.listAllKeywords()),
    ...
    projectsEndpoints.Public.getAdminProjectsByProjectShortcode
      .zServerLogic(restService.findByShortcode),
    projectsEndpoints.Public.getAdminProjectsByProjectShortname
      .zServerLogic(restService.findByShortname),
    projectsEndpoints.Public.getAdminProjectsKeywordsByProjectIri
      .zServerLogic(restService.getKeywordsByProjectIri),
    ...
    projectsEndpoints.Secured.getAdminProjectsByProjectIriMembers
      .serverLogic(restService.getProjectMembersById),
