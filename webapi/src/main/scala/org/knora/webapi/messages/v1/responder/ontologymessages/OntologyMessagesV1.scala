...
/**
  ...
  */
case class EntityInfoGetRequestV1(resourceClassIris: Set[IRI] = Set.empty[IRI],
...
/**
  ...
  * @param userProfile          the profile of the user making the request.
  */
case class StandoffEntityInfoGetRequestV1(standoffClassIris: Set[IRI] = Set.empty[IRI],
...
class PredicateInfoV1(predicateInfoV2: PredicateInfoV2) {
  ...
  def objectsWithLang: Map[String, String] =
    predicateInfoV2.objects.collect {
