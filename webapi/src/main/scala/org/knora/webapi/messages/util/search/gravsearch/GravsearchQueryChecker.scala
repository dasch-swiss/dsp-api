...
import org.knora.webapi.messages.util.search.{ConstructClause, IriRef, QueryVariable, StatementPattern, XsdLiteral}
import org.knora.webapi.messages.util.search.gravsearch.types.{GravsearchEntityTypeInfo, GravsearchTypeInspectionResult, NonPropertyTypeInfo, PropertyTypeInfo}
