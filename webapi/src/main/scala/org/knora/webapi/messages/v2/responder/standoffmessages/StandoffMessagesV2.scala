...
object CreateMappingRequestMetadataV2 extends KnoraJsonLDRequestReaderV2[CreateMappingRequestMetadataV2] {
  ...
  override def fromJsonLD(jsonLDDocument: JsonLDDocument,
      ...
      executionContext: ExecutionContext): Future[CreateMappingRequestMetadataV2] = {
    Future {
      fromJsonLDSync(
...
case class GetMappingResponseV2(
    ...
    standoffEntities: StandoffEntityInfoGetResponseV2) // TODO: there should be a route to obtain a mapping
...
/**
  ...
  */
case class XMLTagToStandoffClass(standoffClassIri: IRI,
...
object StandoffProperties {
  ...
  val dataTypeProperties
    : Set[IRI] = dateProperties ++ intervalProperties ++ timeProperties ++ booleanProperties ++ decimalProperties ++
