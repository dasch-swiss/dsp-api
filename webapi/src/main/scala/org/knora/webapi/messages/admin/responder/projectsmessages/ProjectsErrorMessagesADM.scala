...
object ProjectsErrorMessagesADM {
  ...
  val SHORTCODE_MISSING_ERROR = "Shoetcode cannot be empty."
  val SHORTCODE_INVALID_ERROR = "Shoetcode is invalid."
  val SHORTNAME_MISSING_ERROR = "Shoetname cannot be empty."
  val SHORTNAME_INVALID_ERROR = "Shoetname is invalid."
