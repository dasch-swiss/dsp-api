...
import org.knora.webapi.exceptions.{AssertionException, BadRequestException, DataConversionException, ForbiddenException, NotFoundException}
...
object CreateResourceRequestV2 extends KnoraJsonLDRequestReaderV2[CreateResourceRequestV2] {
    ...
    override def fromJsonLD(jsonLDDocument: JsonLDDocument,
        ...
        for {
            ...
            maybeAttachedToUserIri: Option[SmartIri] = jsonLDDocument.maybeIriInObject(OntologyConstants.KnoraApiV2Complex.AttachedToUser, stringFormatter.toSmartIriWithErr)
...
object UpdateResourceMetadataRequestV2 extends KnoraJsonLDRequestReaderV2[UpdateResourceMetadataRequestV2] {
    ...
    def fromJsonLDSync(jsonLDDocument: JsonLDDocument, requestingUser: UserADM, apiRequestID: UUID): UpdateResourceMetadataRequestV2 = {
        ...
        val maybePermissions: Option[String] = jsonLDDocument.maybeStringWithValidation(OntologyConstants.KnoraApiV2Complex.HasPermissions, stringFormatter.toSparqlEncodedString)
