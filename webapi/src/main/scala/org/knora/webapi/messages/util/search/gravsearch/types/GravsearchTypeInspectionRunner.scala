...
import org.knora.webapi.messages.util.search.{AndExpression, CompareExpression, CompareExpressionOperator, Expression, FilterPattern, FunctionCallExpression, IriRef, OrExpression, QueryTraverser, QueryVariable, StatementPattern, WhereClause, WhereVisitor, XsdLiteral}
