...
import org.knora.webapi.messages.util.search.{AndExpression, BindPattern, CompareExpression, CompareExpressionOperator, ConstructClause, ConstructQuery, Entity, Expression, FilterNotExistsPattern, FilterPattern, FunctionCallExpression, IriRef, LangFunction, MinusPattern, OptionalPattern, OrExpression, OrderCriterion, QueryPattern, QueryVariable, RegexFunction, StatementPattern, UnionPattern, WhereClause, XsdLiteral}
