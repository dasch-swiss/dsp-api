...
/**
  ...
  */
case class LuceneQueryPattern(subj: QueryVariable,
                              obj: QueryVariable,
...
/**
  ...
  * @param querySchema      if this is a Gravsearch query, represents the Knora API v2 ontology schema used in the query.
  */
case class WhereClause(patterns: Seq[QueryPattern],
...
/**
  ...
  * @param querySchema     if this is a Gravsearch query, represents the Knora API v2 ontology schema used in the query.
  */
case class ConstructQuery(constructClause: ConstructClause,
...
/**
  ...
  */
case class SelectQuery(variables: Seq[SelectQueryColumn],
