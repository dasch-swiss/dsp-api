...
trait WhereTransformer {
  ...
  /**
    ...
    */
  def transformStatementInWhere(statementPattern: StatementPattern,
...
/**
  ...
  */
case class TransformedOrderBy(statementPatterns: Seq[StatementPattern] = Vector.empty[StatementPattern],
...
object QueryTraverser {
  ...
  /**
    ...
    * @return the transformed query.
    */
  def transformConstructToConstruct(inputQuery: ConstructQuery,
                                    transformer: ConstructToConstructTransformer): ConstructQuery = {
