...
/**
  ...
  * @param userProfile     the profile of the user making the request.
  */
case class ResourceSearchGetRequestV1(searchString: String,
...
/**
  ...
  *
  */
case class MultipleResourceCreateResponseV1(createdResources: Seq[OneOfMultipleResourcesCreateResponseV1],
...
case class ResourceCreateResponseV1(res_id: IRI,
                                    results: Map[IRI, Seq[ResourceCreateValueResponseV1]] =
                                      Map.empty[IRI, Seq[ResourceCreateValueResponseV1]],
                                    projectADM: ProjectADM)
    extends KnoraResponseV1
    with UpdateResultInProject {
    ...
    def write(propsGetForRegionV1: PropsGetForRegionV1): JsValue = {
      ...
      JsObject(
        properties ++ Map("res_id" -> propsGetForRegionV1.res_id.toJson,
                          "iconsrc" -> propsGetForRegionV1.iconsrc.toJson)) // add res_id and iconsrc to response
    }
  }
