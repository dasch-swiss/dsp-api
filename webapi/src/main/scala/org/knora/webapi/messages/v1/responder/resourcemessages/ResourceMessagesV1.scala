 ...
 */
case class CreateResourceApiRequestV1(
  restype_id: IRI,
  label: String,
 ...
 */
case class CreateResourceFromXmlImportRequestV1(
  restype_id: IRI,
  client_id: String,
  label: String,
  properties: Map[IRI, Seq[CreateResourceValueV1]],
 ...
 */
case class CreateResourceValueV1(
 ...
 * @param userProfile     the profile of the user making the request.
 */
case class ResourceSearchGetRequestV1(
  searchString: String,
 ...
 */
case class ResourceCreateRequestV1(
  resourceTypeIri: IRI,
  label: String,
 ...
 * @param creationDate     the creation date that should be attached to the resource.
 */
case class OneOfMultipleResourceCreateRequestV1(
  resourceTypeIri: IRI,
 ...
 */
case class MultipleResourceCreateResponseV1(
  createdResources: Seq[OneOfMultipleResourcesCreateResponseV1],
 ...
 */
case class ResourceInfoResponseV1(resource_info: Option[ResourceInfoV1] = None, rights: Option[Int] = None)
    extends KnoraResponseV1 {
 ...
 */
case class ResourceFullResponseV1(
 ...
 */
case class ResourceCreateResponseV1(
  res_id: IRI,
 ...
 */
case class ResourceContextV1(
  res_id: Option[Seq[IRI]] = None,
 ...
 */
case class ResourceContextItemV1(
  res_id: IRI,
 ...
 */
case class IncomingV1(ext_res_id: ExternalResourceIDV1, resinfo: ResourceInfoV1, value: Option[String])
 ...
 */
case class ExternalResourceIDV1(id: IRI, pid: IRI)
 ...
 */
case class PropertyGetValueV1(
  person_id: Option[IRI] = None,
 ...
 */
case class ResourceSearchResultRowV1(id: IRI, value: Seq[String], rights: Option[Int] = None) {
...
object SalsahGuiConversions {
  ...
  def salsahGuiElement2Iri(salsahGuiElement: String): IRI =
    salsahGuiElements2Iris.get(salsahGuiElement) match {
      case Some(iri) => iri
      case None =>
        throw new InconsistentRepositoryDataException(s"No IRI found for SALSAH GUI element: $salsahGuiElement")
    }
}
...
object ResourceV1JsonProtocol extends SprayJsonSupport with DefaultJsonProtocol with NullOptions {
  ...
  implicit val createResourceApiRequestV1Format: RootJsonFormat[CreateResourceApiRequestV1] = jsonFormat5(
    CreateResourceApiRequestV1
  )
  implicit val ChangeResourceLabelApiRequestV1Format: RootJsonFormat[ChangeResourceLabelApiRequestV1] = jsonFormat1(
    ChangeResourceLabelApiRequestV1
  )
  ...
  implicit val propertiesGetResponseV1Format: RootJsonFormat[PropertiesGetResponseV1] = jsonFormat1(
    PropertiesGetResponseV1
  )
  implicit val resourceRightsResponseV1Format: RootJsonFormat[ResourceRightsResponseV1] = jsonFormat1(
    ResourceRightsResponseV1
  )
  implicit val resourceSearchResultV1Format: RootJsonFormat[ResourceSearchResultRowV1] = jsonFormat3(
    ResourceSearchResultRowV1
  )
  implicit val resourceSearchResponseV1Format: RootJsonFormat[ResourceSearchResponseV1] = jsonFormat1(
    ResourceSearchResponseV1
  )
  implicit val resourceCreateValueObjectResponseV1Format: RootJsonFormat[ResourceCreateValueObjectResponseV1] =
    jsonFormat14(ResourceCreateValueObjectResponseV1)
  implicit val resourceCreateValueResponseV1Format: RootJsonFormat[ResourceCreateValueResponseV1] = jsonFormat2(
    ResourceCreateValueResponseV1
  )
  implicit val oneOfMultipleResourcesCreateResponseFormat: JsonFormat[OneOfMultipleResourcesCreateResponseV1] =
    jsonFormat3(OneOfMultipleResourcesCreateResponseV1)
  implicit val resourceDeleteResponseV1Format: RootJsonFormat[ResourceDeleteResponseV1] = jsonFormat1(
    ResourceDeleteResponseV1
  )
  implicit val changeResourceLabelResponseV1Format: RootJsonFormat[ChangeResourceLabelResponseV1] = jsonFormat2(
    ChangeResourceLabelResponseV1
  )
  ...
  implicit val graphDataGetResponseV1Format: RootJsonFormat[GraphDataGetResponseV1] = jsonFormat2(
...
object ResourceContextV1JsonProtocol extends SprayJsonSupport with DefaultJsonProtocol {
  ...
  implicit val resourceContextResponseV1Format: RootJsonFormat[ResourceContextResponseV1] = jsonFormat1(
    ResourceContextResponseV1
  )
}
