 ...
 */
case class CreateValueApiRequestV1(
  res_id: IRI,
  prop: IRI,
 ...
 */
case class CreateRichtextV1(
  utf8str: Option[String] = None,
 ...
 * @param comment        a comment to add to the value.
 */
case class ChangeValueApiRequestV1(
  richtext_value: Option[CreateRichtextV1] = None,
  link_value: Option[IRI] = None,
  int_value: Option[Int] = None,
  decimal_value: Option[BigDecimal] = None,
 ...
 * @param userProfile     the profile of the user making the request.
 */
case class ValueVersionHistoryGetRequestV1(
  resourceIri: IRI,
  propertyIri: IRI,
  currentValueIri: IRI,
  userProfile: UserADM
 ...
 */
case class CreateValueRequestV1(
  resourceIndex: Int = 0,
  resourceIri: IRI,
  propertyIri: IRI,
  value: UpdateValueV1,
 ...
 */
case class GenerateSparqlToCreateMultipleValuesResponseV1(
  insertSparql: String,
  unverifiedValues: Map[IRI, Seq[UnverifiedValueV1]]
)
 ...
 * @param apiRequestID         the ID of this API request.
 */
case class ChangeValueRequestV1(
  valueIri: IRI,
  value: UpdateValueV1,
  comment: Option[String] = None,
  featureFactoryConfig: FeatureFactoryConfig,
 ...
 */
case class CreateStandoffTagV1InTriplestore(
 ...
 */
case class TextValueWithStandoffV1(
  utf8str: String,
  language: Option[String] = None,
 ...
 */
case class StillImageFileValueV1(
 ...
 * @param dimY             the Y dimension of the object.
 */
case class DocumentFileValueV1(
  internalMimeType: String,
  internalFilename: String,
  originalFilename: Option[String] = None,
  originalMimeType: Option[String] = None,
...
case class MovingImageFileValueV1(
  internalMimeType: String,
  internalFilename: String,
  originalFilename: Option[String],
  originalMimeType: Option[String] = None,
...
object ApiValueV1JsonProtocol extends SprayJsonSupport with DefaultJsonProtocol with NullOptions {
  ...
  implicit val audioFileValueV1Format: JsonFormat[AudioFileValueV1]             = jsonFormat5(AudioFileValueV1)
