...
/**
  * An enumeration of the possible values of a standoff attribute. Note: do not use the `withName` method to get instances
  * of the values of this enumeration; use `lookup` instead, because it reports errors better.
  */
object StandoffAttributeV1 extends Enumeration {
    // internal name / name in JSON representation  /  corresponding HTML tag (generated by the GUI)
    val paragraph = Value("p")                      // <p>...</p>
    val italic = Value("italic")                    // <em>...</em>
    val bold = Value("bold")                        // <strong>...</strong>
    val underline = Value("underline")              // <u>...</u>
    val strikethrough = Value("strikethrough")      // <s>...</s>
    val link = Value("_link")                       // <a>...</a>
    val header1 = Value("h1")                       // <h1>...</h1>
    val header2 = Value("h2")                       // <h2>...</h2>
    val header3 = Value("h3")                       // <h3>...</h3>
    val header4 = Value("h4")                       // <h4>...</h4>
    val header5 = Value("h5")                       // <h5>...</h5>
    val header6 = Value("h6")                       // <h6>...</h6>
    val superscript = Value("sup")                  // <sup>...</sup>
    val subscript = Value("sub")                    // <sub>...</sub>
    val orderedList = Value("ol")                   // <ol>...</ol>
    val unorderedList = Value("ul")                 // <ul>...</ul>
    val listElement = Value("li")                   // <li>...</li>
    ...
    def lookup(name: String): Value = {
        valueMap.get(name) match {
            case Some(value) => value
            case None => throw BadRequestException(s"Standoff attribute not supported: $name")
        }
    }
...
case class TextValueV1(utf8str: String,
                       textattr: Map[StandoffAttributeV1.Value, Seq[StandoffPositionV1]] = Map.empty[StandoffAttributeV1.Value, Seq[StandoffPositionV1]],
    ...
    /**
      ...
      */
    def flattenStandoff: Seq[(StandoffAttributeV1.Value, StandoffPositionV1)] = {
