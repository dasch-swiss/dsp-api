 ...
 */
case class ResetTriplestoreContentRequestADM(rdfDataObjects: Seq[RdfDataObject],
                                             prependDefaults: Boolean = false,
                                             featureFactoryConfig: FeatureFactoryConfig) extends StoreResponderRequestADM
