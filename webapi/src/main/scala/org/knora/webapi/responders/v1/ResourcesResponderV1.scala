...
class ResourcesResponderV1 extends ResponderV1 {
    ...
    private def getGraphDataResponseV1(graphDataGetRequest: GraphDataGetRequestV1): Future[GraphDataGetResponseV1] = {
        /**
          * The internal representation of a node returned by a SPARQL query generated by the `getLinks` template.
          *
        ...
        /**
          * The internal representation of an edge returned by a SPARQL query generated by the `getLinks` template.
          *
        ...
        /**
          * Represents results returned by a SPARQL query generated by the `getLinks` template.
          *
