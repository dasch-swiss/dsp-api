...
import org.knora.webapi.{ApiV2Complex, IRI, InternalSchema, OntologySchema}
...
object OntologyHelpers {
  ...
  /**
    ...
    */
  def getEntityIrisFromOntologyGraphs(ontologyGraphs: Iterable[OntologyGraph], entityTypes: Set[IRI])(
  ...
  def makeReadClassInfos(
      ...
      allFileValueProps: Set[SmartIri])(implicit stringFormatter: StringFormatter): Map[SmartIri, ReadClassInfoV2] = {
    classDefs.map {
  ...
  /**
    ...
    */
  def makeReadPropertyInfos(propertyDefs: Map[SmartIri, PropertyInfoContentV2],
  ...
  /**
    ...
    */
  def makeGuiAttributeDefinitions(allIndividuals: Map[SmartIri, IndividualInfoContentV2])(
  ...
  /**
    ...
    */
  def constructResponseToPropertyDefinitions(propertyIris: Set[SmartIri],
  ...
  /**
    ...
    */
  def checkOntologyLastModificationDateBeforeUpdate(settings: KnoraSettingsImpl,
                                                    storeManager: ActorRef,
                                                    internalOntologyIri: SmartIri,
  ...
  /**
    ...
    * @return a failed Future if the expected last modification date is not found.
    */
  def checkOntologyLastModificationDateAfterUpdate(settings: KnoraSettingsImpl,
                                                   storeManager: ActorRef,
                                                   internalOntologyIri: SmartIri,
                                                   expectedLastModificationDate: Instant,
                                                   featureFactoryConfig: FeatureFactoryConfig)(
  ...
  /**
    ...
    * @return a failed Future if the expected last modification date is not found.
    */
  private def checkOntologyLastModificationDate(settings: KnoraSettingsImpl,
                                                storeManager: ActorRef,
                                                internalOntologyIri: SmartIri,
                                                expectedLastModificationDate: Instant,
                                                featureFactoryConfig: FeatureFactoryConfig,
  ...
  /**
    ...
    */
  def linkPropertyDefToLinkValuePropertyDef(internalPropertyDef: PropertyInfoContentV2)(
      implicit stringFormatter: StringFormatter): PropertyInfoContentV2 = {
  ...
  /**
    ...
    */
  def overrideCardinalities(classIri: SmartIri,
  ...
  /**
    ...
    *         from its base classes), and each value is the cardinality on the property.
    */
  def inheritCardinalitiesInLoadedClass(classIri: SmartIri,
                                        directSubClassOfRelations: Map[SmartIri, Set[SmartIri]],
                                        allSubPropertyOfRelations: Map[SmartIri, Set[SmartIri]],
                                        directClassCardinalities: Map[SmartIri, Map[SmartIri, KnoraCardinalityInfo]])
