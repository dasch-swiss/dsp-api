...
package object responders {
    ...
    val HIERARCHICAL_LISTS_ROUTER_ACTOR_PATH = RESPONDER_MANAGER_ACTOR_PATH + "/" + HIERARCHICAL_LISTS_ROUTER_ACTOR_NAME
    ...
    val ONTOLOGIES_ROUTER_ACTOR_PATH2 = RESPONDER_MANAGER_ACTOR_PATH2 + "/" + ONTOLOGIES_ROUTER_ACTOR_NAME2
