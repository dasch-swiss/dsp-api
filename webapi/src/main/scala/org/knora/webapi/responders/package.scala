...
package object responders {
    ...
    val HIERARCHICAL_LISTS_ROUTER_ACTOR_NAME = "hierarchicalListsRouter"
    val HIERARCHICAL_LISTS_ROUTER_ACTOR_PATH = RESPONDER_MANAGER_ACTOR_PATH + "/" + "hierarchicalListsRouter"

    val SEARCH_ROUTER_ACTOR_NAME = "searchRouter"
    val SEARCH_ROUTER_ACTOR_PATH = RESPONDER_MANAGER_ACTOR_PATH + "/" + "searchRouter"

    val ONTOLOGY_ROUTER_ACTOR_NAME = "ontologyRouter"
    val ONTOLOGY_ROUTER_ACTOR_PATH = RESPONDER_MANAGER_ACTOR_PATH + "/" + "ontologyRouter"
