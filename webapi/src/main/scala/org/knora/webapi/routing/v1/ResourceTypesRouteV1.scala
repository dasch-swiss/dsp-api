    ...
    path("v1" / "resourcetypes" / Segment) { iri =>
      get { requestContext =>
        val requestMessage = for {
          ...
          resourceTypeIri =
            stringFormatter.validateAndEscapeIri(iri, throw BadRequestException(s"Invalid resource class IRI: $iri"))
      ...
      get { requestContext =>
        val requestMessage = for {
          ...
          vocabularyId =
            params.getOrElse("vocabulary", throw BadRequestException("Required param vocabulary is missing"))
