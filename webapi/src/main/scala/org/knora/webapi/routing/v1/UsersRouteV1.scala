          ...
          parameters("identifier" ? "iri") { (identifier: String) => requestContext =>
            ...
            val requestMessage = if (identifier == "email") {
              ...
              for {
                ...
                userIri =
                  stringFormatter.validateAndEscapeIri(value, throw BadRequestException(s"Invalid user IRI $value"))
        ...
        get {
          ...
          requestContext =>
            val requestMessage = for {
              ...
              checkedUserIri =
                stringFormatter.validateAndEscapeIri(userIri, throw BadRequestException(s"Invalid user IRI $userIri"))
