...
object ListsRouteV1 extends Authenticator {
    ...
    def knoraApiPath(_system: ActorSystem, settings: SettingsImpl, log: LoggingAdapter): Route = {
        ...
        path("v1" / "lists" / Segment) {iri =>
            get {
                ...
                requestContext =>
                    ...
                    val requestMessage = ListExtendedGetRequestV1(listIri, userProfile)
        ...
        path("v1" / "lists" / "nodes" / Segment) {iri =>
            get {
                /* return a list node */
                requestContext =>
                    val userProfile = getUserProfileV1(requestContext)
                    ...
                    val requestMessage = ListNodeInfoGetRequestV1(listIri, userProfile)
