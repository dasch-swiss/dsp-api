...
import org.knora.webapi.messages.v2.responder.{KnoraExternalRequestV2, KnoraExternalResponseV2}
...
object RouteUtilV2 {
    ...
    /**
      ...
      *
      * @param requestMessage   a future containing a [[KnoraExternalRequestV2]] message that should be sent to the responder manager.
      ...
      */
    def runJsonRoute(requestMessage: KnoraExternalRequestV2,
        ...
        val httpResponse: Future[HttpResponse] = for {
            ...
            knoraResponse <- (responderManager ? requestMessage).map {
                case replyMessage: KnoraExternalResponseV2 => replyMessage
