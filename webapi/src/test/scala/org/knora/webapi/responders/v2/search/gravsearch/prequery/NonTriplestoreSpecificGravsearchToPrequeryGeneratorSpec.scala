...
import org.knora.webapi.responders.v2.search.gravsearch.types.{GravsearchTypeInspectionResult, GravsearchTypeInspectionRunner, GravsearchTypeInspectionUtil}
...
class NonTriplestoreSpecificGravsearchToPrequeryGeneratorSpec extends CoreSpec() {
    ...
    "The  NonTriplestoreSpecificGravsearchToPrequeryGenerator object" should {
        ...
        "transform an input query into a prequery" in {
    ...
    val inputQueryWithOptionalSortCriterion =
        """
