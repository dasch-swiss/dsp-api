    ...
    val expectedPageResourceFullResponse = ResourceFullResponseV1(
        ...
        props = Some(PropsV1(properties = Vector(
            PropertyV1(
                locations = Vector(
                    LocationV1(
                        ...
                        duration = 0,
                        fps = 0,
                        path = "http://localhost:1024/incunabula_0000000002.jpg",
                        ny = Some(128),
                        nx = Some(95),
                    ...
                    LocationV1(
                        ...
                        duration = 0,
                        fps = 0,
                        path = "http://localhost:1024/incunabula_0000000002.jp2",
                        ny = Some(110),
                        nx = Some(82),
                        origname = "ad+s167_druck1=0001.tif",
            ...
            PropertyV1(
                ...
                guiorder = Some(2),
                valuetype_id = Some("http://www.knora.org/ontology/incunabula#book"),
                regular_property = 1,
            ...
            PropertyV1(
                ...
                values = Nil,
                occurrence = Some("0-1"),
                attributes = "restypeid=53;numprops=1",
                label = Some("Randleistentyp links"),
                is_annotation = "0",
                guielement = Some("searchbox"),
                guiorder = Some(10),
                valuetype_id = Some("http://www.knora.org/ontology/incunabula#Sideband"),
                regular_property = 1,
    ...
    val expectedRegionFullResource = ResourceFullResponseV1(
        ...
        incoming = Vector(
            ...
            IncomingV1(
                ...
                resinfo = ResourceInfoV1(
                    ...
                    locations = None,
                    preview = None,
                    restype_iconsrc = Some("region.gif"),
        ...
        props = Some(PropsV1(properties = Vector(
            ...
            PropertyV1(
                ...
                value_iconsrcs = Vector(Some("region.gif")),
                ...
                values = Vector(LinkV1(
                    valueResourceClassIcon = Some("region.gif"),
            ...
            PropertyV1(
                ...
                value_iconsrcs = Vector(Some("page.gif")),
                ...
                values = Vector(LinkV1(
                    valueResourceClassIcon = Some("page.gif"),
