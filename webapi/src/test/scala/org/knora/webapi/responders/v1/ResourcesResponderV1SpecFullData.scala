  ...
  val expectedBookResourceFullResponse: ResourceFullResponseV1 = ResourceFullResponseV1(
    ...
    incoming = Vector(
      IncomingV1(
        ...
        ext_res_id = ExternalResourceIDV1(
          ...
          id = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/ab79ffa43935"
        )
      ),
      IncomingV1(
        ...
        ext_res_id = ExternalResourceIDV1(
          pid = "http://www.knora.org/ontology/knora-base#hasLinkTo",
          id = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/cb1a74e3e2f6"
        )
      )
    ),
    props = Some(
      PropsV1(properties = Vector(
        PropertyV1(
          locations = Nil,
          ...
          value_ids = Vector("http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/c5058f3a/values/8653a672"),
        ...
        PropertyV1(
          ...
          value_restype = Vector(None),
          comments = Vector(None),
          value_ids = Vector("http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/c5058f3a/values/c3295339"),
          values = Vector(TextValueSimpleV1(
        ...
        PropertyV1(
          ...
          value_ids = Vector(
            "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/c5058f3a/values/184e99ca01",
            "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/c5058f3a/values/db77ec0302",
            "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/c5058f3a/values/9ea13f3d02"
          ),
          values = Vector(
            TextValueSimpleV1(
        ...
        PropertyV1(
          ...
          value_restype = Vector(None),
          comments = Vector(None),
          value_ids = Vector("http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/c5058f3a/values/92faf25701"),
          values = Vector(TextValueSimpleV1(
        ...
        PropertyV1(
          ...
          value_restype = Vector(None),
          comments = Vector(None),
          value_ids = Vector("http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/c5058f3a/values/10e00c7acc2704"),
          values = Vector(TextValueSimpleV1(
        ...
        PropertyV1(
          ...
          value_restype = Vector(None),
          comments = Vector(None),
          value_ids = Vector("http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/c5058f3a/values/5524469101"),
          values = Vector(TextValueSimpleV1(
            utf8str = "Dimension: 8\u00B0"
          )),
          occurrence = Some("0-1"),
        ...
        PropertyV1(
          ...
          value_restype = Vector(None),
          comments = Vector(None),
          value_ids = Vector("http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/c5058f3a/values/0ca74ce5"),
          values = Vector(TextValueSimpleV1(
            utf8str = "Basel"
          )),
          occurrence = Some("0-1"),
        ...
        PropertyV1(
          ...
          value_restype = Vector(None),
          comments = Vector(None),
          value_ids = Vector("http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/c5058f3a/values/cfd09f1e01"),
          values = Vector(
            DateValueV1(
        ...
        PropertyV1(
          ...
          value_restype = Vector(None),
          comments = Vector(None),
          value_ids = Vector("http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/c5058f3a/values/497df9ab"),
          values = Vector(TextValueSimpleV1(
    ...
    resdata = Some(
      ResourceDataV1(
        ...
        res_id = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/c5058f3a"
      )),
    resinfo = Some(
      ResourceInfoV1(
  ...
  val expectedPageResourceFullResponse: ResourceFullResponseV1 = ResourceFullResponseV1(
    ...
    props = Some(
      PropsV1(properties = Vector(
        ...
        PropertyV1(
          ...
          value_restype = Vector(None),
          comments = Vector(None),
          value_ids = Vector("http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/8a0b1e75/values/61cb927602"),
          values = Vector(TextValueSimpleV1(
        ...
        PropertyV1(
          ...
          value_restype = Vector(None),
          comments = Vector(None),
          value_ids = Vector("http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/8a0b1e75/values/3e3d4dc0e922"),
          values = Vector(TextValueSimpleV1(
        ...
        PropertyV1(
          ...
          value_restype = Vector(None),
          comments = Vector(None),
          value_ids = Vector("http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/8a0b1e75/values/e80b2d895f23"),
          values = Vector(TextValueSimpleV1(
        ...
        PropertyV1(
          ...
          value_restype = Vector(None),
          comments = Vector(None),
          value_ids = Vector("http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/8a0b1e75/values/aa488c2203"),
          values = Vector(TextValueSimpleV1(
        ...
        PropertyV1(
          ...
          value_restype = Vector(None),
          comments = Vector(None),
          value_ids = Vector("http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/8a0b1e75/values/e71e39e902"),
        ...
        PropertyV1(
          ...
          comments = Vector(None),
          value_ids =
            Vector("http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/8a0b1e75/values/ac9ddbf4-62a7-4cdc-b530-16cbbaa265bf"),
          values = Vector(LinkV1(
            ...
            targetResourceIri = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/c5058f3a"
          )),
          occurrence = Some("1"),
    ...
    resdata = Some(
      ResourceDataV1(
        ...
        res_id = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/8a0b1e75"
      )),
    resinfo = Some(
      ResourceInfoV1(
