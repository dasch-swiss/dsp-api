...
object ValuesResponderV1Spec {
  ...
  private val miscResourceIri = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/miscResource"
...
class ValuesResponderV1Spec extends CoreSpec(ValuesResponderV1Spec.config) with ImplicitSender {
  ...
  private def checkValueGetResponseWithStandoff(response: ValueGetResponseV1): Unit = {
    ...
    assert(
      response.value
        ...
        .utf8str == "Zusammengebunden mit zwei weiteren Drucken von Johann Amerbach",
      "comment utf8str value did not match"
    )

    // expected Standoff information for <http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/e41ab5695c/values/d3398239089e04> in incunabula-data.ttl
    val standoff = Vector(
      StandoffTagV2(
  ...
  private def checkImageFileValueChange(received: ChangeFileValueResponseV1,
    ...
    received.locations.foreach { location: LocationV1 =>
      assert(location.origname == request.file.originalFilename, "wrong original file name")
    }
  }
  ...
  "The values responder" should {
    ...
    "query a text value containing Standoff" in {
      responderManager ! ValueGetRequestV1(
        valueIri = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/e41ab5695c/values/d3398239089e04",
        featureFactoryConfig = defaultFeatureFactoryConfig,
        userProfile = incunabulaUser
      )
    ...
    "query a LinkValue" in {
      responderManager ! LinkValueGetRequestV1(
        subjectIri = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/8a0b1e75",
    ...
    "not add a new value to a nonexistent resource" in {
      responderManager ! CreateValueRequestV1(
        resourceIri = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/nonexistent",
        propertyIri = "http://www.knora.org/ontology/0803/incunabula#book_comment",
    ...
    "not add a new value to a deleted resource" in {
      responderManager ! CreateValueRequestV1(
        resourceIri = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/9935159f67",
        propertyIri = "http://www.knora.org/ontology/0803/incunabula#book_comment",
        value = TextValueSimpleV1("Comment 1"),
        featureFactoryConfig = defaultFeatureFactoryConfig,
        userProfile = incunabulaUser,
    ...
    "not add a new value to a resource that the user doesn't have permission to modify" in {
      responderManager ! CreateValueRequestV1(
        resourceIri = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/e41ab5695c",
        propertyIri = "http://www.knora.org/ontology/0803/incunabula#book_comment",
        value = TextValueSimpleV1("Comment 1"),
        featureFactoryConfig = defaultFeatureFactoryConfig,
        userProfile = incunabulaUser,
    ...
    "not add a new value of the wrong type" in {
      responderManager ! CreateValueRequestV1(
        resourceIri = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/21abac2162",
    ...
    "not add a new value that would violate a cardinality restriction" in {
      ...
      responderManager ! CreateValueRequestV1(
        ...
        value = LinkUpdateV1(targetResourceIri = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/e41ab5695c"),
        featureFactoryConfig = defaultFeatureFactoryConfig,
        userProfile = incunabulaUser,
        apiRequestID = UUID.randomUUID
      )
    ...
    "add a new text value containing a Standoff resource reference, and create a hasStandoffLinkTo direct link and a corresponding LinkValue" in {
      ...
      responderManager ! LinkValueGetRequestV1(
        subjectIri = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/21abac2162",
    ...
    "add a new Integer value (seqnum of a page)" in {
      ...
      responderManager ! CreateValueRequestV1(
        resourceIri = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/8a0b1e75",
        propertyIri = "http://www.knora.org/ontology/0803/incunabula#seqnum",
    ...
    "create a link between two resources" in {
      val resourceIri = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/cb1a74e3e2f6"
    ...
    "not create a duplicate link" in {
      val createValueRequest = CreateValueRequestV1(
        resourceIri = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/cb1a74e3e2f6",
        propertyIri = OntologyConstants.KnoraBase.HasLinkTo,
        value = LinkUpdateV1(
          targetResourceIri = zeitglöckleinIri
        ),
    ...
    "not create a link that points to a resource of the wrong class" in {
      responderManager ! CreateValueRequestV1(
        ...
        value = LinkUpdateV1(
          targetResourceIri = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/8a0b1e75" // an incunabula:page, not an incunabula:book
        ),
        featureFactoryConfig = defaultFeatureFactoryConfig,
        userProfile = incunabulaUser,
        apiRequestID = UUID.randomUUID
    ...
    "change a link" in {
      val linkSourceIri = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/cb1a74e3e2f6"
      val linkTargetIri = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/21abac2162"
    ...
    "change the partOf property of a page" in {
      ...
      val linkTargetIri = "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/e41ab5695c"

      partOfLinkValueIri.set(
        "http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/8a0b1e75/values/3a7b5130-22c2-4400-a794-062b7a3e3436")
    ...
    "change the season of a image:bild from summer to winter" in {
      ...
      val winter = "http://rdfh.ch/lists/wI8G0Ps-F1USDL-F06aRHA/eda2792605"

      responderManager ! ChangeValueRequestV1(
        value = HierarchicalListValueV1(winter),
        featureFactoryConfig = defaultFeatureFactoryConfig,
        userProfile = imagesUser,
        valueIri = "http://rdfh.ch/wI8G0Ps-F1USDL-F06aRHA/d208fb9357d5/values/bc90a9c5091004",
        apiRequestID = UUID.randomUUID
      )
    ...
    "create a season of a image:bild" in {
      ...
      val summer = "http://rdfh.ch/lists/wI8G0Ps-F1USDL-F06aRHA/526f26ed04"
      ...
      responderManager ! CreateValueRequestV1(
        ...
        resourceIri = "http://rdfh.ch/wI8G0Ps-F1USDL-F06aRHA/691e7e2244d5",
        apiRequestID = UUID.randomUUID
      )
    ...
    "delete two text values containing the same standoff resource reference" in {
      val thingWithTextValues = "http://rdfh.ch/U7HxeFSUEQCHJxSLahw3AA/a-thing-with-text-values"
      val firstTextValue = "http://rdfh.ch/U7HxeFSUEQCHJxSLahw3AA/a-thing-with-text-values/values/1"
      val secondTextValue = "http://rdfh.ch/U7HxeFSUEQCHJxSLahw3AA/a-thing-with-text-values/values/2"
    ...
    "add a new text value with language" in {
      ...
      responderManager ! CreateValueRequestV1(
        ...
        resourceIri = "http://rdfh.ch/U7HxeFSUEQCHJxSLahw3AA/a-thing-with-text-valuesLanguage",
        apiRequestID = UUID.randomUUID
      )
