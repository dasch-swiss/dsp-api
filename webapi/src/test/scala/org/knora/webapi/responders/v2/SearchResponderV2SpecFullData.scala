...
import org.knora.webapi.{ApiV2Simple, InternalSchema, Settings, SharedTestDataADM}
    ...
    val fulltextSearchForNarr = ReadResourcesSequenceV2(
        ...
        resources = Vector(
            ReadResourceV2(
                ...
                values = Map("http://www.knora.org/ontology/0803/incunabula#description".toSmartIri -> Vector(ReadNonLinkValueV2(
    ...
    val booksWithTitleZeitgloeckleinResponse = ReadResourcesSequenceV2(
        ...
        resources = Vector(
            ReadResourceV2(
                ...
                projectADM = SharedTestDataADM.incunabulaProject,
                creationDate = Instant.parse("2016-03-02T15:05:10Z"),
                values = Map("http://www.knora.org/ontology/0803/incunabula#title".toSmartIri -> Vector(ReadNonLinkValueV2(
                    valueContent = TextValueContentV2(
                        standoffAndMapping = None,
                        ontologySchema = InternalSchema,
                        valueHasLanguage = None,
