...
class SearchResponderV2SpecFullData(implicit stringFormatter: StringFormatter) {
    ...
    val fulltextSearchForNarr = ReadResourcesSequenceV2(
        resources = Vector(
            ReadResourceV2(
                values = Map("http://www.knora.org/ontology/incunabula#description".toSmartIri -> Vector(ReadValueV2(
                ...
                resourceClass = "http://www.knora.org/ontology/incunabula#page".toSmartIri,
                label = "p7v",
    ...
    val fulltextSearchForDinge = ReadResourcesSequenceV2(
        resources = Vector(ReadResourceV2(
            values = Map("http://www.knora.org/ontology/anything#hasText".toSmartIri -> Vector(
                ReadValueV2(
                    valueContent = TextValueContentV2(
                        valueType = OntologyConstants.KnoraBase.TextValue.toSmartIri,
                        comment = None,
            ...
            resourceClass = "http://www.knora.org/ontology/anything#Thing".toSmartIri,
    ...
    val booksWithTitleZeitgloeckleinResponse = ReadResourcesSequenceV2(
        resources = Vector(
            ReadResourceV2(
                values = Map("http://www.knora.org/ontology/incunabula#title".toSmartIri -> Vector(ReadValueV2(
                    valueContent = TextValueContentV2(
                        valueType = OntologyConstants.KnoraBase.TextValue.toSmartIri,
                        comment = None,
                        standoff = None,
