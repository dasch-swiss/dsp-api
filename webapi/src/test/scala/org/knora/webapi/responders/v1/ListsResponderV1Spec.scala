          ...
          ListNodeV1(
            ...
            children = Vector(
              ListNodeV1(
                ...
                level = 2,
                children = Vector(
                  ListNodeV1("http://rdfh.ch/lists/00FF/97744976b801", Some("hotel_a"), Some("Hotel A"), Nil, 3, 0),
                  ListNodeV1("http://rdfh.ch/lists/00FF/30a89cafb801", Some("hotel_b"), Some("Hotel B"), Nil, 3, 1),
                  ListNodeV1("http://rdfh.ch/lists/00FF/c9dbefe8b801", Some("hotel_c"), Some("Hotel C"), Nil, 3, 2),
                  ListNodeV1("http://rdfh.ch/lists/00FF/620f4322b901", Some("hotel_d"), Some("Hotel D"), Nil, 3, 3),
                  ListNodeV1("http://rdfh.ch/lists/00FF/fb42965bb901", Some("hotel_e"), Some("Hotel E"), Nil, 3, 4),
                  ListNodeV1("http://rdfh.ch/lists/00FF/9476e994b901", Some("hotel_f"), Some("Hotel F"), Nil, 3, 5),
                  ListNodeV1("http://rdfh.ch/lists/00FF/2daa3cceb901", Some("hotel_g"), Some("Hotel G"), Nil, 3, 6),
                  ListNodeV1("http://rdfh.ch/lists/00FF/c6dd8f07ba01", Some("hotel_h"), Some("Hotel H"), Nil, 3, 7),
                  ListNodeV1("http://rdfh.ch/lists/00FF/5f11e340ba01", Some("hotel_i"), Some("Hotel I"), Nil, 3, 8),
                  ListNodeV1("http://rdfh.ch/lists/00FF/f844367aba01", Some("hotel_j"), Some("Hotel J"), Nil, 3, 9),
                  ListNodeV1("http://rdfh.ch/lists/00FF/917889b3ba01", Some("hotel_k"), Some("Hotel K"), Nil, 3, 10),
                  ListNodeV1("http://rdfh.ch/lists/00FF/2aacdcecba01", Some("hotel_l"), Some("Hotel L"), Nil, 3, 11),
                  ListNodeV1("http://rdfh.ch/lists/00FF/c3df2f26bb01", Some("hotel_m"), Some("Hotel M"), Nil, 3, 12),
                  ListNodeV1("http://rdfh.ch/lists/00FF/5c13835fbb01", Some("hotel_n"), Some("Hotel N"), Nil, 3, 13),
                  ListNodeV1("http://rdfh.ch/lists/00FF/f546d698bb01", Some("hotel_o"), Some("Hotel O"), Nil, 3, 14),
                  ListNodeV1("http://rdfh.ch/lists/00FF/8e7a29d2bb01", Some("hotel_p"), Some("Hotel P"), Nil, 3, 15),
                  ListNodeV1("http://rdfh.ch/lists/00FF/27ae7c0bbc01", Some("hotel_q"), Some("Hotel Q"), Nil, 3, 16),
                  ListNodeV1("http://rdfh.ch/lists/00FF/c0e1cf44bc01", Some("hotel_r"), Some("Hotel R"), Nil, 3, 17),
                  ListNodeV1("http://rdfh.ch/lists/00FF/5915237ebc01", Some("hotel_s"), Some("Hotel S"), Nil, 3, 18),
                  ListNodeV1("http://rdfh.ch/lists/00FF/f24876b7bc01", Some("hotel_t"), Some("Hotel T"), Nil, 3, 19),
                  ListNodeV1("http://rdfh.ch/lists/00FF/8b7cc9f0bc01", Some("hotel_u"), Some("Hotel U"), Nil, 3, 20),
                  ListNodeV1("http://rdfh.ch/lists/00FF/24b01c2abd01", Some("hotel_v"), Some("Hotel V"), Nil, 3, 21),
                  ListNodeV1("http://rdfh.ch/lists/00FF/9f29173c3b02", Some("hotel_w"), Some("Hotel W"), Nil, 3, 22),
                  ListNodeV1("http://rdfh.ch/lists/00FF/bde36f63bd01", Some("hotel_x"), Some("Hotel X"), Nil, 3, 23),
                  ListNodeV1("http://rdfh.ch/lists/00FF/5617c39cbd01", Some("hotel_y"), Some("Hotel Y"), Nil, 3, 24),
                  ListNodeV1("http://rdfh.ch/lists/00FF/ef4a16d6bd01", Some("hotel_z"), Some("Hotel Z"), Nil, 3, 25)
                ),
