...
class SearchRouteV2R2RSpec extends R2RSpec {
  ...
  "The Search v2 Endpoint" should {
    ...
    "perform a Gravsearch query for the page of a book whose seqnum equals 10, returning the seqnum and the link value" in {
      ...
      val gravsearchQuery =
        """PREFIX incunabula: <http://0.0.0.0:3333/ontology/0803/incunabula/simple/v2#>
                  ...
                  |
                  |        ?page knora-api:isPartOf <http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/b6b5ff1eb703> .
                  |
                  ...
                  |
                  |        <http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/b6b5ff1eb703> a knora-api:Resource .
                  |
                  |        ?page incunabula:seqnum ?seqnum .
    ...
    "get the regions belonging to a page" in {
      val gravsearchQuery =
        """    PREFIX incunabula: <http://0.0.0.0:3333/ontology/0803/incunabula/simple/v2#>
                  ...
                  |
                  |        ?region knora-api:isRegionOf <http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/9d626dc76c03> .
                  |
                  ...
                  |
                  |        <http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/9d626dc76c03> a knora-api:Resource .
                  |
                  |        ?region knora-api:hasGeometry ?geom .
    ...
    "get a book a page points to and include the page in the results (all properties present in WHERE clause)" in {
      val gravsearchQuery =
        """
                  ...
                  |    ?book incunabula:title ?title .
                  |
                  |    <http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/50e7460a7203> knora-api:isPartOf ?book .
                  |
                  |    <http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/50e7460a7203> knora-api:seqnum ?seqnum .
                  |
                  |    <http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/50e7460a7203> knora-api:hasStillImageFile ?file .
                  |
                  |} WHERE {
                  |
                  |    ?book a knora-api:Resource .
                  ...
                  |    knora-api:isPartOf knora-api:objectType knora-api:Resource .
                  |
                  |    <http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/50e7460a7203> a knora-api:Resource .
                  |
                  |    <http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/50e7460a7203> knora-api:seqnum ?seqnum .
    ...
    "get incoming links pointing to an incunbaula:book, excluding isPartOf and isRegionOf" in {
      val gravsearchQuery =
        """
                  ...
                  |
                  |     ?incomingRes ?incomingProp <http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/8be1b7cf7103> .
                  |
                  |} WHERE {
                  |
                  ...
                  |     ?incomingRes ?incomingProp <http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/8be1b7cf7103> .
                  |
                  |     <http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/8be1b7cf7103> a knora-api:Resource .
                  |
                  ...
                  |
                  |     FILTER NOT EXISTS {
                  |         ?incomingRes  knora-api:isRegionOf <http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/8be1b7cf7103> .
                  |     }
                  |
                  |     FILTER NOT EXISTS {
                  |         ?incomingRes  knora-api:isPartOf <http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/8be1b7cf7103> .
                  |     }
                  |
                  |} OFFSET 0
                """.stripMargin
    ...
    "do a Gravsearch query for a letter that links to a specific person via two possible properties" in {
      ...
      val gravsearchQuery =
        """
                  ...
                  |
                  |        ?letter ?linkingProp1  <http://rdfh.ch/yTerZGyxjZVqFMNNKXCDPF/VvYVIy-FSbOJBsh2d9ZFJw> .
                  |
                  |
                  |    } WHERE {
                  ...
                  |        ?letter ?linkingProp1 <http://rdfh.ch/yTerZGyxjZVqFMNNKXCDPF/VvYVIy-FSbOJBsh2d9ZFJw> .
                  |
                  |        <http://rdfh.ch/yTerZGyxjZVqFMNNKXCDPF/VvYVIy-FSbOJBsh2d9ZFJw> a knora-api:Resource .
                  |
    ...
    "run a Gravsearch query that searches for a single resource specified by its IRI" in {
      val gravsearchQuery =
        """
                  ...
                  |
                  |} WHERE {
                  |     BIND(<http://rdfh.ch/U7HxeFSUEQCHJxSLahw3AA/H6gBWUuJSuuO-CilHV8kQw> AS ?thing)
                  |
                  |     ?thing a knora-api:Resource .
                  |     ?thing a anything:Thing .
                  |     ?thing anything:hasText ?text .
    ...
    "do a Gravsearch query for the pages of a book whose seqnum is lower than or equals 10, with the book as the main resource" in {
      ...
      val gravsearchQuery =
        """PREFIX incunabula: <http://0.0.0.0:3333/ontology/0803/incunabula/simple/v2#>
                  ...
                  |    } WHERE {
                  |        BIND(<http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/b6b5ff1eb703> AS ?book)
                  |        ?book a knora-api:Resource .
                  |
                  |        ?book incunabula:title ?title .
                  |        incunabula:title knora-api:objectType xsd:string .
    ...
    "get incoming links pointing to an incunbaula:book, excluding isPartOf (with type inference)" in {
      val gravsearchQuery =
        """
                  ...
                  |     ?incomingRes ?incomingProp <http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/8be1b7cf7103> .
                  |
                  |     <http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/8be1b7cf7103> a incunabula:book .
                  |
                  |
                  |     FILTER NOT EXISTS {
                  |         ?incomingRes knora-api:isPartOf <http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/8be1b7cf7103> .
    ...
    "get a book a page points to and include the page in the results (all properties present in WHERE clause) (submitting the complex schema)" in {
      val gravsearchQuery =
        """
                  ...
                  |    <http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/50e7460a7203> knora-api:seqnum ?seqnum .
                  |
                  |    <http://rdfh.ch/6NIOckxUlWnYChtXoH7A_g/50e7460a7203> knora-api:hasStillImageFileValue ?file .
                  |
                  |} WHERE {
                  |
                  |    ?book a incunabula:book .
    ...
    "search for an anything:Thing that has a link to a specified other thing" in {
      val gravsearchQuery =
        """PREFIX anything: <http://0.0.0.0:3333/ontology/0001/anything/v2#>
                  ...
                  |CONSTRUCT {
                  |    ?thing knora-api:isMainResource true .
                  |    ?thing anything:hasOtherThing <http://rdfh.ch/U7HxeFSUEQCHJxSLahw3AA/start> .
                  |} WHERE {
                  |    ?thing a anything:Thing .
                  |    ?thing anything:hasOtherThing <http://rdfh.ch/U7HxeFSUEQCHJxSLahw3AA/start> .
                  |}""".stripMargin
    ...
    "search for a list value that refers to a particular list node that has subnodes (submitting the complex schema)" in {
      val gravsearchQuery =
        """
                  ...
                  |        ?thing anything:hasListItem ?listItem .
                  |
                  |        ?listItem knora-api:listValueAsListNode <http://rdfh.ch/lists/U7HxeFSUEQCHJxSLahw3AA/treeList> .
                  |
                  |    }
                """.stripMargin
    ...
    "search for a beol:letter with list value that refers to a particular list node (submitting the complex schema)" in {
      val gravsearchQuery =
        """
                  ...
                  |        ?letter beol:hasSubject ?subject .
                  |
                  |        ?subject knora-api:listValueAsListNode <http://rdfh.ch/lists/yTerZGyxjZVqFMNNKXCDPF/logarithmic_curves> .
                  |
                  |    }
                """.stripMargin
    ...
    "search for a standoff link using the knora-api:standoffLink function specifying an Iri for the target resource (submitting the complex schema)" in {
      val gravsearchQuery =
        """
                  ...
                  |    ?text knora-api:textValueHasStandoff ?standoffTag .
                  |    ?standoffTag a knora-api:StandoffLinkTag .
                  |    FILTER knora-api:standoffLink(?thing, ?standoffTag, <http://rdfh.ch/U7HxeFSUEQCHJxSLahw3AA/a-thing>)
                  |    <http://rdfh.ch/U7HxeFSUEQCHJxSLahw3AA/a-thing> a anything:Thing .
                  |}
                """.stripMargin
    ...
    "search for a standoff link using the knora-api:standoffLink function specifying an Iri for the target resource, referring to the target resource in the function call only (submitting the complex schema)" in {
      val gravsearchQuery =
        """
                  ...
                  |    FILTER knora-api:standoffLink(?thing, ?standoffTag, <http://rdfh.ch/U7HxeFSUEQCHJxSLahw3AA/a-thing>)
                  |
                  |    # Note that <http://rdfh.ch/U7HxeFSUEQCHJxSLahw3AA/a-thing> is only used as a argument in the function, not in any other statement
                  |}
                """.stripMargin
    ...
    "perform a search that compares two variables representing resources (in the simple schema)" in {
      ...
      // We should get one result, not including <http://rdfh.ch/yTerZGyxjZVqFMNNKXCDPF/XNn6wanrTHWShGTjoULm5g> ("letter to self").
