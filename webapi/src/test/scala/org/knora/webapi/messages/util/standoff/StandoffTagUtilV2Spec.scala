...
class StandoffTagUtilV2Spec extends CoreSpec {
    ...
    "StandoffTagUtilV2" should {
        ...
        "should create the correct StandoffTagV2 from SPARQL query results" in {
            ...
            val standoffTagsV1: Vector[StandoffTagV2] = Await.result(StandoffTagUtilV2.createStandoffTagsV2FromSelectResults(sparqlResultsV1, responderManager, anythingUserProfile), 10.seconds)

            val standoffTagsV2: Vector[StandoffTagV2] = Await.result(StandoffTagUtilV2.createStandoffTagsV2FromSelectResults(sparqlResultsV2, responderManager, anythingUserProfile), 10.seconds)
