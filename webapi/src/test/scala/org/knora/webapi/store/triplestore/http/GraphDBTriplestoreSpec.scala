 ...
 */
class GraphDBTriplestoreSpec extends CoreSpec("GraphDBTriplestoreTestSystem", GraphDBTriplestoreSpec.config) with ImplicitSender {
    ...
    */
    "The HttpTriplestoreActor using GraphDB " when {
