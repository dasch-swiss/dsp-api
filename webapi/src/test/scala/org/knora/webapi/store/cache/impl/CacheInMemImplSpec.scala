...
/**
 * This spec is used to test [[org.knora.webapi.store.cache.impl.CacheInMemImpl]].
 */
class CacheInMemImplSpec extends UnitSpec() {
  ...
  private val inMemCache: CacheInMemImpl.type = CacheInMemImpl
