...
curl -X POST -H "Content-type:application/x-www-form-urlencoded" --data-urlencode update='DROP ALL' http://localhost:8080/fuseki/knora-test/update > /dev/null
...
curl -F filedata=@../_test_data/all_data/incunabula-data.ttl http://localhost:8080/fuseki/knora-test/data?graph=http://www.knora.org/data/incunabula > /dev/null
...
curl -F filedata=@../_test_data/all_data/anything-data.ttl http://localhost:8080/fuseki/knora-test/data?graph=http://www.knora.org/data/anything > /dev/null
...
curl -F filedata=@../_test_data/all_data/biblio-data.ttl http://localhost:8080/fuseki/knora-test/data?graph=http://www.knora.org/data/biblio > /dev/null
curl -F filedata=@../_test_data/all_data/beol-data.ttl http://localhost:8080/fuseki/knora-test/data?graph=http://www.knora.org/data/beol > /dev/null
