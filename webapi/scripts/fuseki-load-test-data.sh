...
curl -F filedata=@../_test_data/ontologies/standoff-onto.ttl http://localhost:3030/knora-test/data?graph=http://www.knora.org/ontology/standoff > /dev/null
curl -F filedata=@../_test_data/all_data/standoff-data.ttl http://localhost:3030/knora-test/data?graph=http://www.knora.org/data/standoff > /dev/null
