...
curl -F filedata=@../../knora-ontologies/knora-base-permissions.ttl http://localhost:3030/knora-test/data?graph=http://www.knora.org/ontology/knora-base > /dev/null
...
curl -F filedata=@../../knora-ontologies/knora-base-admin.ttl http://localhost:3030/knora-test/data?graph=http://www.knora.org/ontology/knora-base > /dev/null
