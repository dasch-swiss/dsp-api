...
upload-graph ../../test_data/demo_data/images-demo-data.ttl http://www.knora.org/data/wI8G0Ps-F1USDL-F06aRHA
upload-graph ../../test_data/ontologies/anything-onto.ttl http://www.knora.org/ontology/0001/anything
upload-graph ../../test_data/all_data/anything-data.ttl http://www.knora.org/data/U7HxeFSUEQCHJxSLahw3AA
...
upload-graph ../../test_data/all_data/beol-data.ttl http://www.knora.org/data/yTerZGyxjZVqFMNNKXCDPF
upload-graph ../../test_data/ontologies/webern-onto.ttl http://www.knora.org/ontology/0806/webern
upload-graph ../../test_data/all_data/webern-data.ttl http://www.knora.org/data/r5rM3chy87PJU1NZPFx3WQ
