...
curl -X POST --data-urlencode 'update@./graphdb-se-knora-index-create.rq' $GRAPHDB/repositories/knora-test-unit/statements

printf "\n${GREEN}Lucene Index created.${NO_COLOUR}\n\n"
