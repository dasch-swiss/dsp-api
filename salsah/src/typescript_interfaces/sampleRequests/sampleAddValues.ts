...
let textattrWithHref: basicMessageComponents.textattr = JSON.parse("{\"_link\":[{\"start\":0,\"end\":6,\"href\":\"http://www.google.ch\"}],\"p\":[{\"start\":0,\"end\":7}]}");

let textattr: basicMessageComponents.textattr = JSON.parse("{\"italic\":[{\"start\":0,\"end\":4},{\"start\":17,\"end\":21}],\"bold\":[{\"start\":9,\"end\":12}],\"p\":[{\"start\":0,\"end\":22}]}");

let textattrKnoraLink: basicMessageComponents.textattr = JSON.parse("{\"_link\":[{\"start\":0,\"end\":4,\"href\":\"http://data.knora.org/a-thing\",\"resid\":\"http://data.knora.org/a-thing\"}],\"p\":[{\"start\":0,\"end\":5}]}");
