...
object SharedTestData {
  ...
  val password1        = PasswordHash.make("password1", passwordStrength).fold(e => throw e.head, v => v)
  ...
  val password2 = PasswordHash.make("password2", passwordStrength).fold(e => throw e.head, v => v)
  ...
  val password3   = PasswordHash.make("password3", passwordStrength).fold(e => throw e.head, v => v)
