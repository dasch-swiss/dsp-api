...
Then try opening [http://localhost:3333/v1/resources/http%3A%2F%2Frdfh.ch%2F00c5058f3a](http://localhost:3333/v1/resources/http%3A%2F%2Frdfh.ch%2F00c5058f3a) in a web browser. You should see a response in JSON describing a book.
