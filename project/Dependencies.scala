...
object Dependencies {
  ...
  val kamonCore = "io.kamon" %% "kamon-core" % "2.1.5" // Scala 3 compatible
  ...
  // serialization
  val chill = "com.twitter" %% "chill" % "0.9.5" // Scala 3 incompatible
  ...
  val scallop = "org.rogach" %% "scallop" % "3.5.1" // Scala 3 compatible
  ...
  val testcontainers = "org.testcontainers" % "testcontainers" % "1.16.0" // Scala 3 compatible
